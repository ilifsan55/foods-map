...
const wheelContentsSolo = ['ラーメン', 'カレー', 'ハンバーガー', '牛丼', 'そば', 'ドーナツ', 'うどん', '中華'];/* eslint-disable-line max-len */
const wheelContentsParty = ['焼肉', '回転寿司', 'イタリアン', 'ハンバーガー', '中華', '和食', 'ラーメン', 'インド料理'];/* eslint-disable-line max-len */
const wheelContents = wheelContentsSolo;

const colorCode = ['#FF6961', '#FFb480', '#F8f38d', '#42d6a4', '#08cad1', '#59adf6', '#9d94ff', '#c780e8'];/* eslint-disable-line max-len */
...
function DrawWheel() {
    ...
    const setToSolo = () => {
        dispatch(setContents(wheelContentsSolo));
    }
    const setToParty = () => {
        dispatch(setContents(wheelContentsParty));
